...
public class Prestacao_contas  implements AcaoRotinaJava{
...
public  String P_Codnat = ""; 
public String P_Codcenus = "";
public String P_Codtipoper = "";
public BigDecimal codinat = new BigDecimal(0);
public BigDecimal Codcenus = new BigDecimal(0);
public BigDecimal Codtipoper = new BigDecimal(0);
...
public void doAction(ContextoAcao ctx) throws Exception {
		...
		if (ctx.getParam("CODNAT") != null) {
			P_Codnat = ctx.getParam("CODNAT").toString();
			codinat = new BigDecimal(P_Codnat);
		}
		
		if (ctx.getParam("CODCENUS") != null) {
			P_Codcenus = ctx.getParam("CODCENUS").toString();
			Codcenus = new BigDecimal(P_Codcenus);
		}
		
		if (ctx.getParam("CODTIPOPER") != null) {
			P_Codtipoper = ctx.getParam("CODTIPOPER").toString();
			Codtipoper = new BigDecimal(P_Codtipoper);
		}
	...
	private void geraNota(Registro line, ContextoAcao ctx) throws Exception {
		...
		switch (P_tipo) {
		case "1": ///CONTA SANKHYA LINCEÇA
			this.newNota = criaCabecalho(new BigDecimal(5), new BigDecimal(221), new BigDecimal(810), new BigDecimal(6060000), new BigDecimal(130), new BigDecimal(10106), BigDecimal.ZERO, codusu, P_Observacao, "A", "F", new BigDecimal(800000000),new BigDecimal(3040800),"J",Valor_Unitario);
	        
			insertnaite(this.newNota, new BigDecimal(1),new BigDecimal(5), new BigDecimal(13681), new BigDecimal(0),"S", codusu,
	        ...
	        mensagem.append(" *Lançamento de Conta Sankhya Feita é :* ");
			mensagem.append(" :: "+newNota);
			System.out.println("Msg para polichat" + mensagem);
			break;
		
		case "2": ///CONTA INTERNET VIVO
			this.newNota = criaCabecalho(new BigDecimal(5), new BigDecimal(231), new BigDecimal(929), new BigDecimal(3040600), new BigDecimal(130), new BigDecimal(10106), BigDecimal.ZERO, codusu, P_Observacao, "A", "F", new BigDecimal(800000000),new BigDecimal(3040800),"Q",Valor_Unitario);
	        
			insertnaite(this.newNota, new BigDecimal(1),new BigDecimal(5), new BigDecimal(18663), new BigDecimal(0),"S", codusu,
	        		new BigDecimal(1),Valor_Unitario ,Valor_Unitario,"UN", new BigDecimal(0),"N","N","A","S");
			//criarSolicitacaoDeLiberacao2(new Integer(44));	
	        ...
	        mensagem.append(" *Lançamento de Conta VIVO Feita é :* ");
			mensagem.append(" :: "+newNota);
			System.out.println("Msg para polichat" + mensagem);
			break;
		
		case "3": ///CONTA FIOS PBIX
			this.newNota = criaCabecalho(new BigDecimal(5), new BigDecimal(221), new BigDecimal(158120), new BigDecimal(3040600), new BigDecimal(130), new BigDecimal(10106), BigDecimal.ZERO, codusu, P_Observacao, "A", "F", new BigDecimal(800000000),new BigDecimal(3040600),"J",Valor_Unitario);
	        
			insertnaite(this.newNota, new BigDecimal(1),new BigDecimal(5), new BigDecimal(13684), new BigDecimal(0),"S", codusu,
	        		new BigDecimal(1),Valor_Unitario ,Valor_Unitario,"UN", new BigDecimal(0),"N","N","A","S");
			//criarSolicitacaoDeLiberacao2(new Integer(44));	
	        ...
	        mensagem.append(" *Lançamento de Conta FIOS Feita é :* ");
			mensagem.append(" :: "+newNota);
			System.out.println("Msg para polichat" + mensagem);
			break;	
			
		case "4": ///CONTA NAABLEE
			this.newNota = criaCabecalho(new BigDecimal(5), new BigDecimal(221), new BigDecimal(161072), new BigDecimal(6060000), new BigDecimal(130), new BigDecimal(10106), BigDecimal.ZERO, codusu, P_Observacao, "A", "F", new BigDecimal(800000000),new BigDecimal(6060000),"J",Valor_Unitario);
	        ...
	        mensagem.append(" *Lançamento de Conta N-ABBLE Feita é :* ");
			mensagem.append(" :: "+newNota);
			System.out.println("Msg para polichat" + mensagem);
			break;
			
		case "5": ///CONTA ERPC
			this.newNota = criaCabecalho(new BigDecimal(5), new BigDecimal(221), new BigDecimal(159244), new BigDecimal(6060000), new BigDecimal(130), new BigDecimal(10201), BigDecimal.ZERO, codusu, P_Observacao, "A", "F", new BigDecimal(800000000),new BigDecimal(6060000),"J",Valor_Unitario);
	        ...
	        mensagem.append(" *Lançamento de Conta ERPC APP Feita é :* ");
			mensagem.append(" :: "+newNota);
			System.out.println("Msg para polichat" + mensagem);
			break;
			
		case "6": ///CONTA SIDI
			this.newNota = criaCabecalho(new BigDecimal(5), new BigDecimal(221), new BigDecimal(161323), new BigDecimal(3040600), new BigDecimal(130), new BigDecimal(10106), BigDecimal.ZERO, codusu, P_Observacao, "A", "F", new BigDecimal(800000000),new BigDecimal(3040600),"J",Valor_Unitario);
	        ...
	        mensagem.append(" *Lançamento de Conta SIDI Feita é :* ");
			mensagem.append(" :: "+newNota);
			System.out.println("Msg para polichat" + mensagem);
			break;
			
		case "7": ///CONTA TD SYNNEX
			this.newNota = criaCabecalho(new BigDecimal(5), new BigDecimal(221), new BigDecimal(158954), new BigDecimal(6060000), new BigDecimal(130), new BigDecimal(10106), BigDecimal.ZERO, codusu, P_Observacao, "A", "F", new BigDecimal(800000000),new BigDecimal(6060000),"J",Valor_Unitario);
	        ...
	        mensagem.append(" *Lançamento de Conta TD SYNNEX (OFFICE) Feita é :* ");
			mensagem.append(" :: "+newNota);
			System.out.println("Msg para polichat" + mensagem);
			break;	
			
		case "8": ///AVULSO
			this.newNota = criaCabecalho(new BigDecimal(5), Codtipoper, Parc_gas, codinat, new BigDecimal(130), Codcenus, BigDecimal.ZERO, codusu, P_Observacao, "A", "F", new BigDecimal(800000000),codinat,"J",Valor_Unitario);
