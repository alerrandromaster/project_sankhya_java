...
public class autorizar_salcred implements AcaoRotinaJava {
	 ...
	 AuthenticationInfo auth = AuthenticationInfo.getCurrent();
	  ...
	  public void doAction(ContextoAcao contextoAcao) throws Exception {
	    	...
	    	if (this.msgErro.equals("")) {
	    		msg  = "NUMERO DO FIN" + newFin + "NUMERO RE"+newFre + "Deposito Autorizado com Sucesso!!" ;
	    		contextoAcao.setMensagemRetorno(msg);
			     Registro avisoSistema = contextoAcao.novaLinha("TSIAVI");
			     avisoSistema.setCampo("NUAVISO",null);
			     MS = "SALDO / TERMO LANÇADO NRO: "+ "<br>" + Nunota + " Hora:" +" " +TimeUtils.getNow();
			     avisoSistema.setCampo("TITULO", "TERMO");
	  ...
	  private void getinfo (Registro line, ContextoAcao contextoAcao) throws Exception {
		  ...
		  Nufin = (BigDecimal)line.getCampo("NUFIN");
	    	...
	    	CodConta = contextoAcao.getParam("CONTBANCO").toString();
	    	System.out.println("Codigo da Conta Param é: " + CodConta);
	    	BigDecimal codigo_conta = new BigDecimal(CodConta);
	    	System.out.println("Codigo da Conta convertido é : " + codigo_conta);
	    	TipoTitulo = contextoAcao.getParam("TIPTIT").toString();
	    	System.out.println("Codigo da Titulo Param é: " + TipoTitulo);
	    	BigDecimal Tiptit = new BigDecimal(TipoTitulo);
	    	System.out.println("Codigo da Titulo convertido é: " + Tiptit);
	 	...
	 	rset1.nativeSelect(sqlIt1.toString());
		    ...
		    sqlIt4.append(" * ");
		    sqlIt4.append(" FROM TGFCAB ");
		    sqlIt4.append(" WHERE NUNOTA = " + Nunota);
		    ...
		    if (rset4.next())
		    {
		    	...
		    	//DTVENC = (Date) rset4.getDate("DTVENC");
		    	...
		    	HISTORICO = rset4.getString("OBSERVACAO");
		    	DHTIPOPER = rset4.getTimestamp("DHTIPOPER");
		    	vlrdesdob = rset4.getString("VLRNOTA");
		    ...
		    if (CodigoTop.compareTo(new BigDecimal(9008)) != 0 || NuCompess.compareTo(new BigDecimal(0)) != 0 || VerificaDH.compareTo(new BigDecimal(0)) != 0 || Reg.equals(new BigDecimal(1))  )   {
		    	{
	  ...
	  public BigDecimal criaFin(BigDecimal empresa,BigDecimal Numnota) throws Exception {
			...
			cabecalhoVO.setProperty("DESDOBRAMENTO", "1");
			cabecalhoVO.setProperty("DTVENC", TimeUtils.getNow());
			...
			cabecalhoVO.setProperty("CODTIPOPER",CodigoTop );
			    	...
			    	cabecalhoVO.setProperty("NOSSONUM", numnota);
			    	...
			    	cabecalhoVO.setProperty("PROVISAO", "N");
